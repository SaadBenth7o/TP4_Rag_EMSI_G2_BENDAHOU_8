...
public class TestRoutage {
    public static void main(String[] args) throws URISyntaxException {
        ...
        EmbeddingStore<TextSegment> embeddingStore1 = creerEmbeddingStore("LLM_Course_RAG.pdf", embeddingModel);
        EmbeddingStore<TextSegment> embeddingStore2 = creerEmbeddingStore("ArtDeco.pdf", embeddingModel);
        ...
        descriptions.put(retriever1, "Cours DE  RAG ET LLM ");
        descriptions.put(retriever2, "ART DECO ARCHITECTURE ");
